...
void power_mon_calc_and_display(power_mon_zones zone, power_mon_v_a_w v_a_w) {
    ...
    if (zone == system_total) {
        ...
        if (v_a_w == volts) {
            ...
            output_to_disp = (delta_volts / power_mon_21v_rs) * 21;
            disp_write(output_to_disp);
        }
        ...
        if (v_a_w == volts) {
            ...
            output_to_disp = (delta_volts / power_mon_5v_rs) * 5;
            disp_write(output_to_disp);
        }
        ...
        if (v_a_w == volts) {
            ...
            output_to_disp = (delta_volts / power_mon_f_c_rs) * pd_power_cont_dfp_current_voltage;
            disp_write(output_to_disp);
        }
        ...
        if (v_a_w == volts) {
            ...
            output_to_disp = (delta_volts / power_mon_b_c_rs) * pd_power_cont_ufp_current_voltage;
            disp_write(output_to_disp);
        }
